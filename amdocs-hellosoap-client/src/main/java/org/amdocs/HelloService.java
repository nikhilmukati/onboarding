 ...
 * 
 */
@WebServiceClient(name = "HelloService", targetNamespace = "http://amdocs.org", wsdlLocation = "http://localhost:8080/Hello-ws/services/Hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICE_QNAME = new QName("http://amdocs.org", "HelloService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/Hello-ws/services/Hello?wsdl");
    ...
    public Hello getHello() {
        return super.getPort(new QName("http://amdocs.org", "Hello"), Hello.class);
    }
    ...
    public Hello getHello(WebServiceFeature... features) {
        return super.getPort(new QName("http://amdocs.org", "Hello"), Hello.class, features);
    }
